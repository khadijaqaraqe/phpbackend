    ...
    if(!empty($data->title) && !empty($data->text)){     
      ...
      /*   if ($data->fileSource) {
        ...
        if($items->create()) {         
            ...
            echo json_encode(array("message" => "Generalization was added."));
        } else {         
            http_response_code(503);        
            echo json_encode(array("message" => "Unable to add Generalization."));
        } 
       
    } else {    
        http_response_code(400);    
        echo json_encode(array("message" => "Unable to create Generalization. Data is incomplete."));
    }
