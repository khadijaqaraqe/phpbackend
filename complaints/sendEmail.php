...
//SMTP = smtp.secureserver.net
 ini_set("SMTP","bethlehem.email.gov.ps");
ini_set("smtp_port","25");
ini_set("sendmail_from","kqaraqe@bethlehem.gov.ps"); 
//; For win32 only
...
$header = "From:kqaraqe@bethlehem.gov.ps \r\n";
$header .= "Cc:kqaraqe@bethlehem.gov.ps \r\n";
