...
$newsData = $Publications->createMagazine((array)$items);
  if($newsData) {         
    http_response_code(200);          
    echo json_encode(array("message" => "Magazine was created."));
  } else {         
    http_response_code(503);        
    echo json_encode(array("message" => "Unable to create Magazine."));
  } 
