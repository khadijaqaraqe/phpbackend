<?php
  ...
  cors();
    ...
    $items->writer = $data->writer;
    $items->category = 1;	
    $items->text = $data->Text;
    
    $items->alt_text =$data->Title;
    $items->description =$data->Title;
  ...
  if($items->create()) {         
    ...
    echo json_encode(array("message" => "Employee Article was created."));
  } else {         
    http_response_code(503);        
    echo json_encode(array("message" => "Unable to create employee article."));
  } 
